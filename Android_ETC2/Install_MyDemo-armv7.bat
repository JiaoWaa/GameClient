...
if "%ANDROIDHOME%"=="" set ANDROIDHOME=C:/Users/AA/AppData/Local/Android/Sdk
...
%ADB% %DEVICE% install MyDemo-armv7.apk
@if "%ERRORLEVEL%" NEQ "0" goto Error
%ADB% %DEVICE% shell rm -r %STORAGE%/UE4Game/MyDemo
%ADB% %DEVICE% shell rm -r %STORAGE%/UE4Game/UE4CommandLine.txt
%ADB% %DEVICE% shell rm -r %STORAGE%/obb/com.YourCompany.MyDemo
%ADB% %DEVICE% shell rm -r %STORAGE%/Android/obb/com.YourCompany.MyDemo
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/com.YourCompany.MyDemo
